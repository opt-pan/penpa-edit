...
onload = function() {
    ...
    if (document.getElementById("english").innerHTML === "EN") {
        selectBox = new vanillaSelectBox("#mode_choices", {
            ...
            "maxHeight": 250,
            "search": true,
            "translations": { "all": "全", "items": "項目", "selectAll": "全てチェック", "clearAll": "全てチェックを外す" }
        });
    } else {
        selectBox = new vanillaSelectBox("#mode_choices", {
            "disableSelectAll": false,
    ...
    if (tab_initial.length > 0) {
        if (document.getElementById("english").innerHTML === "EN") {
            liteModeButton.innerText = 'Penpa Liteを無効化';
        } else {
        ...
        if (document.getElementById("english").innerHTML === "EN") {
            liteModeButton.innerText = 'Penpa Liteを有効化';
        } else {
    ...
    document.getElementById("mode_choices").onchange = function() {
        ...
        if (can_use_lite()) {
            ...
            if (liteModeButton.innerText === "Disable Penpa Lite" || liteModeButton.innerText === "Penpa Liteを無効化") {
