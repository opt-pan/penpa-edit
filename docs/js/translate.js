function trans_text(button_text,label_text,css_fontsize,css_width){
  ...
  if(pu.mmode === "solve"){
    document.getElementById("title").innerHTML = ["解答モード","Answer Mode"][a];
    document.getElementById("tb_delete").value = ["解答消去","Delete"][a];
  }else{
    document.getElementById("title").innerHTML = ["編集モード","Solve Mode"][a];
...
function trans(){
  var css_fontsize = {
    ...
    "ms4":["14px","12px"],
    "ms5":["14px","12px"],
    "st_surface1_lb":["14px","9px"],
    "st_surface3_lb":["14px","9px"],
    "st_surface4_lb":["14px","12px"],
    "st_surface2_lb":["14px","12px"],
    "st_surface5_lb":["14px","9px"],
    "st_surface6_lb":["14px","12px"],
    "st_surface7_lb":["14px","12px"],
    "st_surface8_lb":["14px","12px"],
    "sub_line2_lb":["14px","12px"],
    "sub_line4_lb":["14px","12px"],
    "sub_lineE2_lb":["14px","12px"],
    "sub_lineE4_lb":["14px","12px"],
    "sub_number7_lb":["14px","11px"],
    "sub_specialsquareframe_lb":["14px","11px"],
    "st_line13_lb":["14px","11px"],
    "st_line30_lb":["14px","11px"],
    "st_line40_lb":["14px","11px"],
    "st_lineE13_lb":["14px","11px"],
    "st_lineE8_lb":["14px","11px"],
    "st_lineE30_lb":["14px","11px"],
    "st_wall17_lb":["14px","11px"],
    "st_wall14_lb":["14px","11px"],
    "st_number1_lb":["14px","11px"],
    "st_number2_lb":["14px","11px"],
    "st_number3_lb":["14px","11px"],
    "st_number4_lb":["14px","11px"],
    "st_number0_lb":["14px","10px"],
    "st_number6_lb":["14px","10px"],
    "st_number7_lb":["14px","10px"],
    "st_number5_lb":["14px","11px"],
    "st_symbol1_lb":["14px","11px"],
    "st_symbol2_lb":["14px","11px"],
    "st_cage15_lb":["14px","11px"],
  }

  var css_width = {
    "mo_combi_lb":["50px","60px"],
    "sub_number7_lb":["50px","60px"],
    "st_surface1_lb":["32px","40px"],
    "st_surface3_lb":["32px","40px"],
    "st_surface5_lb":["32px","40px"],
    "st_symbol1_lb":["45px","70px"],
    "st_symbol2_lb":["45px","90px"],
    "subc5":["50px","60px"],
    "st_number0_lb":["32px","38px"],
    "st_line3_lb":["32px","40px"],
    "st_lineE3_lb":["32px","40px"],
    "st_lineE8_lb":["32px","45px"],
    "st_wall3_lb":["32px","40px"],
    "st_wall14_lb":["32px","40px"],
  }
  ...
  var label_text = {
    ...
    "st_surface1_lb":["濃灰","DarkGray"],
    "st_surface3_lb":["薄灰","LightGray"],
    "st_surface4_lb":["黒","Black"],
    "st_surface2_lb":["緑","Green"],
    "st_surface5_lb":["水","LightBlue"],
  ...
  trans_text(button_text,label_text,css_fontsize,css_width);
}
